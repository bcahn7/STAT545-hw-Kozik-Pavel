...
For this assignment I used gapminder data and R markdown, click here to see the results [**click here to see the results**](https://github.com/Kozp/STAT545-hw01-Kozik-Pavel/blob/Side-Branch/hw01_gapminder.md) 
