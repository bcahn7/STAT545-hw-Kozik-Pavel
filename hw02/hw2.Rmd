...
A slightly different approach is identifying the number of unique obervations for a specific variable of interest. This can be done through the *n_distinct* function.
